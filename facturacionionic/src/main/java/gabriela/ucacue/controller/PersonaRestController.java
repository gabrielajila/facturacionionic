package gabriela.ucacue.controller;
...
import gabriela.ucacue.repositorio.PersonaRepositorio;
...
public class PersonaRestController {
	...
	public Page<Persona> filtrarPersona(@PathVariable Integer page){
		Pageable pageable = PageRequest.of(page, 3,Sort.by("nombre"));
	...
	public ResponseEntity<?> modificarCliente(@RequestBody Persona persona, BindingResult result,
		...
		try {
			...
			cliente.setCoordenadas(persona.getCoordenadas());
